...
class ChatCompletionBase(BaseModel):
    ...
    """
    completion_id: str = Field(..., description="The unique identifier for the chat completion. When starting a new chat, this will be a new UUID. When continuing a previous chat, this will be the same as the previous chat completion id.")
