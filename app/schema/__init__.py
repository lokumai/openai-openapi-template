...
ensure data integrity and provide clear contracts for the API.

Modules:
- chat_schema.py: Defines schemas for chat completion requests, responses,
                  messages, and plot data structures used in the API.
"""
